...
public class RedisHelper {
    ...
    public static String SCAN_INIT_CURSOR       = REDIS_SCAN_INIT_CURSOR;
    ...
    public static <T> T execute(JedisPool jedisPool, org.aggregateframework.transaction.repository.helper.JedisCallback<T> callback) {
        try (Jedis jedis = jedisPool.getResource()) {
            return callback.doInJedis(jedis);
        }
    }

    public static <T> T execute(ShardedJedisPool jedisPool, org.aggregateframework.transaction.repository.helper.ShardedJedisCallback<T> callback) {
