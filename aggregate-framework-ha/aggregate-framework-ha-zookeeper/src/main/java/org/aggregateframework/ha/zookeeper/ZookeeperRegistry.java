package org.aggregateframework.ha.zookeeper;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.aggregateframework.ha.registry.Registration;
import org.aggregateframework.ha.registry.Registry;
import org.aggregateframework.ha.registry.RegistryException;
...
public class ZookeeperRegistry implements Registry {
    ...
    static final Logger log = LoggerFactory.getLogger(ZookeeperRegistry.class.getSimpleName());
        ...
        try {
            ...
            for (int i = 0; i < max && !ok; i++) {
                try {
                    ...
                    } catch (KeeperException.NoNodeException ignore2) {
